...
function isSceneHeading(text) {
  return /^(INT\.|EXT\.|INT\/EXT\.|I\/E\.)/i.test(text.trim());
}
...
export default function ScriptGraph() {
  ...
  async function analyze() {
    ...
    try {
      ...
      const p1a = await callClaude(buildPhase1APrompt(compressedText, totalPages, sceneLengths, sceneSkeletons), 6000);
                ...
                return (
                  <div key={entry.id} style={{ background: T.bgCard, border: `1px solid ${c}45`, borderRadius: T.radiusLg, padding: "16px 18px" }}>
                    ...
                    <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
                      ...
                      <StatBadge label="Structure" value={`${entry.naturalStructure?.actCount}-Act`} color={c} />
